...
const slides = [
  {
    ...
    title: "About CodeThinker",
    subtitle:
      "CodeThinker is a learning platform built for developers who want to learn programming, practice their skills, and grow with modern web technologies.",
    button: "Learn More",
  },
  {
    image:
    ...
    subtitle:
      "Learn HTML, CSS, JavaScript, React, and other technologies through practical tutorials and hands-on coding.",
  ...
  },
  {
    ...
    subtitle:
      "Our goal is to help aspiring developers turn ideas into real projects and become confident programmers.",
    button: "Start Learning",
  },
];
export default function HeroSwiper2() {
    return (
